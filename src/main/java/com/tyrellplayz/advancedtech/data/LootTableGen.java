...
public class LootTableGen extends LootTableProvider {
    ...
    public String getName() {
        return "LootTables: "+ AdvancedTech.MOD_ID;
    }
    ...
    private static class Block extends BlockLoot {
        ...
        protected Iterable<net.minecraft.world.level.block.Block> getKnownBlocks() {
            return ForgeRegistries.BLOCKS.getValues().stream().filter(block -> block.getRegistryName() != null && AdvancedTech.MOD_ID.equals(block.getRegistryName().getNamespace())).collect(Collectors.toSet());
        }
